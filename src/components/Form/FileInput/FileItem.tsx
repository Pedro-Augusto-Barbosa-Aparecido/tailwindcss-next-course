  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-error-50 bg-error-100 text-error-500 dark:bg-error-500/5 dark:border-error-500/30 dark:text-error-400',
        deleteButton:
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-sm font-bold text-error-700 dark:text-error-400">
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-violet-100 dark:bg-zinc-400">
              <div
