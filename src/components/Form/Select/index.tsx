    ...
    <SelectPrimitive.Root {...rest}>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={8}
          className="z-10 w-[--radix-select-trigger-width] animate-slideDownAndFade rounded-lg border border-zinc-300 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-800"
        >
